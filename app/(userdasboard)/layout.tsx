...
export default function UserDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navLinks = [
    ...
    { href: "/dashboard/appliedJob", label: "Applied Jobs", icon: Briefcase },
    { href: "/dashboard/favoriteJob", label: "Favorite Jobs", icon: Bookmark },
    { href: "/dashboard/jobAlert", label: "Job Alert", icon: Bell, badge: "09" },
  ...
  const topNavLinks = [
    ...
    { href: "/dashboard/jobAlert", label: "Job Alerts" },
  ];
          ...
          <div className="container mx-auto px-4 sm:px-8 py-3 flex items-center justify-between gap-4">
            <div className="flex items-center gap-8">
              ...
              <div className="hidden md:flex items-center border border-gray-200 rounded-md px-3 py-1.5 w-80 bg-white">
                <span className="text-xs text-gray-500 border-r border-gray-200 pr-2 mr-2">English</span>
          ...
          <div className="w-full md:w-64 border-r border-gray-100 p-4 sm:p-6 flex flex-col justify-between">
                ...
                {navLinks.map((link) => {
                  ...
                  return (
                    <Link
                      key={link.href}
                      href={link.href}
                      className={`flex items-center justify-between px-3 py-2.5 text-sm font-medium transition rounded-md ${
                        isActive
                          ? "text-blue-600 bg-blue-50 border-l-4 border-blue-600 rounded-r-md"
            ...
            <div className="mt-8 pt-4 border-t border-gray-100">
              <button
                ...
                className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-gray-500 hover:text-gray-900 w-full transition"
              >
